...
xcopy /s /i /y src "%TEMP_DIR%\src"
if errorlevel 1 goto :error
xcopy /s /i /y configs "%TEMP_DIR%\configs"
if errorlevel 1 goto :error
...
mkdir "%TEMP_DIR%\data"
if errorlevel 1 goto :error
xcopy /s /i /y data\processed "%TEMP_DIR%\data\processed"
if errorlevel 1 goto :error
xcopy /s /i /y data\eval "%TEMP_DIR%\data\eval"
if errorlevel 1 goto :error
