...
Portal [Toàn bộ kiến trúc backend](architecture/index.html) nhúng chín diagram
...
[Mở diagram](architecture/system-overview.html)
...
[Mở diagram](architecture/backend-module-map.html)
...
[Mở diagram](architecture/request-lifecycle.html)
...
[Mở diagram](architecture/structured-execution.html)
...
[Mở diagram](architecture/hybrid-retrieval.html)
...
[Mở diagram](architecture/answer-composition.html)
...
[Mở diagram](architecture/ingestion-retrieval.html)
...
[Mở diagram](architecture/runtime-startup.html)
...
[Mở diagram](architecture/evaluation-lifecycle.html)
...
1. Mở [portal kiến trúc](architecture/index.html).
