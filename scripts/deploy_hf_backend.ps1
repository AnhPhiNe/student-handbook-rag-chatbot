...
Copy-RequiredDirectory "src\api" "src\api"
Copy-RequiredDirectory "src\common" "src\common"
Copy-RequiredDirectory "src\generation" "src\generation"
Copy-RequiredDirectory "src\retrieval" "src\retrieval"
Copy-RequiredDirectory "src\services" "src\services"
Copy-RequiredFile "configs\ai_router.yaml" "configs\ai_router.yaml"
Copy-RequiredFile "configs\answer_generation.yaml" "configs\answer_generation.yaml"
...
Copy-RequiredFile "constraints-runtime.txt" "constraints-runtime.txt"
